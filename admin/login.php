...
if (isset($_POST['btn-submit'])) {
   ...
   $user = get_one_data("SELECT * FROM users WHERE username='$username' AND password='$password'");
         ...
         <div class="form__sign--in">
            ...
            <form action="" method="post">
               <div class="form__sign--in--account">
                  ...
                  <div class="form__sign--in--account--user">
                     <input class="form-check-input" type="checkbox" <?= ($check) ? "checked" : "" ?> name="remember"
                        value="1">
                     <label class="form-check-label">Keep me logged in</label>
                  </div>
                  <div class="form__sign--in--account--user">
                     <p>No account? <a href="./registration.php">Đăng kí</a></p>
                  </div>
                  <div class="form__sign--in--account--user--button">
                     ...
                     <div class="form__sign--in--account--user--dashboard">
                        <button class="btn btn__info" type="submit" name="btn-submit">Đăng nhập</button>
                     </div>
                  </div>
               </div>
            </form>
