	...
	<div class="content border p-3">
		<form action="add_product.php" method="post" enctype="multipart/form-data">
			<div class="input__news">
				...
				<div class="item">
					<input type="number" class="form-control input__control" name="product_quantity"
						placeholder="Số lượng sản phẩm">
				</div>
				<div class="item">
					<input type="date" class="form-control input__control" name="product_created_date"
						placeholder="Ngày nhập">
				</div>
				<div class="item">
					<input type="date" class="form-control input__control" name="product_update_date"
